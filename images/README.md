...
#### # work-around this by enabling your local repos but also registering the nodes and attaching a pool at the same time, https://bugzilla.redhat.com/show_bug.cgi?id=1514989 
