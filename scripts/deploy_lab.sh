...
if [ "$TYPE" == "oso" ]; then
	...
	ssh root@hv4.home.nicknach.net /cloud/scripts/new.sh omaster01 $TEMPLATE 16384 2 52:54:00:fb:09:ec &
	ssh root@hv3.home.nicknach.net /cloud/scripts/new.sh omaster02 $TEMPLATE 16384 2 52:54:00:18:58:01 &
	ssh root@hv5.home.nicknach.net /cloud/scripts/new.sh omaster03 $TEMPLATE 16384 2 52:54:00:18:58:02 &
	ssh root@hv4.home.nicknach.net /cloud/scripts/new.sh onode01 $TEMPLATE 16384 2 52:54:00:db:14:7d &
	ssh root@hv3.home.nicknach.net /cloud/scripts/new.sh onode02 $TEMPLATE 16385 2 52:54:00:68:4a:e3 &
	ssh root@hv5.home.nicknach.net /cloud/scripts/new.sh onode03 $TEMPLATE 16384 2 52:54:00:68:54:49 &
    ssh root@hv4.home.nicknach.net /cloud/scripts/new.sh oinfra01 $TEMPLATE 16384 2 52:54:00:18:58:03 &
    ssh root@hv3.home.nicknach.net /cloud/scripts/new.sh oinfra02 $TEMPLATE 16384 2 52:54:00:18:59:04 &
    ssh root@hv5.home.nicknach.net /cloud/scripts/new.sh oinfra03 $TEMPLATE 16384 2 52:54:00:18:73:04 &
